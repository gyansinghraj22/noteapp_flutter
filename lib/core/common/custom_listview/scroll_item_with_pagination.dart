...
class ScrollableItemWithPagination<T> extends StatefulWidget {
  ...
  ScrollableItemWithPagination(
      {required this.onNewItemsDemanded,
      required this.itemBuilder,
      required this.items,
      this.loading = false,
      this.onRefresh});
  @override
  _ScrollableItemWithPaginationState<T> createState() =>
      _ScrollableItemWithPaginationState<T>();
}

class _ScrollableItemWithPaginationState<T>
    extends State<ScrollableItemWithPagination<T>> {
